...
Le JSX (JavaScript XML) est une extension au JavaScript qui comprend une synthaxe proche du XML. Le JSX peut aussi etre utilisé avec d'autres frameworks comme Vue par exemple. Comme en HTML, le JSX comprend des tags qui peuvent avoir de nombreux attributs.
...
* Les évènements React sont ecrit en camelCase avec comme prefixe `on`
...
En React, il est possible d'ajouter des conditions afin d'afficher ou non des composants.
