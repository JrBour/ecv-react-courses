...
Grace a l'acces a la methode `dispatch` et au state, il est possible de pouvoir y appeller des actions/selectors directement depuis les actions aynchrones.

```

// Fous l'exemple de l'exercice de la derniere fois
// Edit summary
